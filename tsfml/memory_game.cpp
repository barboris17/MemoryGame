...
public:
    ...
    void loadTextures() {
        if (!menuBackgroundTexture.loadFromFile("memory.jpg")) {
            cout << "Íå óäàëîñü çàãðóçèòü menu_background.jpg. Èñïîëüçóåòñÿ ñòàíäàðòíûé ôîí." << endl;
            Image gradientImage;
        ...
        if (!gameBackgroundTexture.loadFromFile("gamefon.jpg")) {
            cout << "Íå óäàëîñü çàãðóçèòü game_background.jpg. Èñïîëüçóåòñÿ ñòàíäàðòíûé ôîí." << endl;
            Image gradientImage;
            gradientImage.create(1280, 720, Color::Transparent);
            for (int y = 0; y < 720; ++y) {
                for (int x = 0; x < 1280; ++x) {
    ...
    void initializeGame() {
        if (!font.loadFromFile("arial.ttf")) {
            cout << "Øðèôò íå íàéäåí! Èñïîëüçóåòñÿ ñòàíäàðòíûé." << endl;
        }
